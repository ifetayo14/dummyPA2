...
class DataPendetaController extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('pendeta.pendetaAktifPendeta', compact('dataPendeta'));
    }
    ...
    {
        return view('pendeta.addPendetaAktifPendeta');
    }
    ...
    public function store(Request $request)
    {
        ...
        $pendetaAktif->save();
        return redirect('/dataPendeta ')->with('success', 'Data Ditambah');
    }
    ...
    {
        return view('pendeta.detailPendetaAktifPendeta', compact('pendetaAktif'));
    }
    ...
    {
        return view('pendeta.editAktifPendeta', compact('pendetaAktif'));
    }
    ...
    public function update(Request $request, PendetaAktif $pendetaAktif)
    {
        ...
        return redirect('/dataPendeta ')->with('success', 'Data Diubah');
    }
    ...
    public function destroy(PendetaAktif $pendetaAktif)
    {
        ...
        return redirect('/pendetaPensiunPendeta ')->with('success', 'Data Dihapus');
    }
}
