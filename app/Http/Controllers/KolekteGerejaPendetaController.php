...
class KolekteGerejaPendetaController extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('pendeta.kolektePendeta', compact('kolekteGereja'));
    }
    ...
    {
        return view('pendeta.addKolekteGerejaPendeta');
    }
    ...
    public function store(Request $request)
    {
        ...
        $kasGereja->save();
        return redirect('/kolektePendeta ')->with('success', 'Data Ditambah');
    }
    ...
    {
        return view('pendeta.detailKolekteGerejaPendeta', compact('kolekteGereja'));
    }
    ...
    {
        return view('pendeta.editKolektePendeta', compact('kolekteGereja'));
    }
    ...
    public function update(Request $request, Kolekte $kolekteGereja)
    {
        ...
        return redirect('/kolektePendeta ')->with('success', 'Data Diubah');
    }
    ...
    public function destroy(Kolekte $kolekteGereja)
    {
        ...
        return redirect('/kolektePendeta ')->with('success', 'Data Dihapus');
    }
}
