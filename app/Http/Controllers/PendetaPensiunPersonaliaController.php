...
class PendetaPensiunPersonaliaController extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('personalia.pendetaPensiunPersonalia', compact('dataPendeta'));
    }
    ...
    {
        return view('personalia.addPendetaPensiunPersonalia');
    }
    ...
    public function store(Request $request)
    {
        ...
        $dataPendeta -> save();
        return redirect('/pendetaPensiunPersonalia') -> with('success', 'Data Ditambah');
    }
    ...
    {
        return view('personalia.detailPendetaPensiunPersonalia', compact('pendetaPensiun'));
    }
    ...
    {
        return view('personalia.editPendetaPensiunPersonalia', compact('pendetaPensiun'));
    }
    ...
    public function update(Request $request, PendetaPensiun $pendetaPensiun)
    {
        ...
        return redirect('/pendetaPensiunPersonalia ')->with('success', 'Data Diubah');
    }
    ...
    public function destroy(PendetaPensiun $pendetaPensiun)
    {
        ...
        return redirect('/pendetaAktifPersonalia ')->with('success', 'Data Dihapus');
    }
}
