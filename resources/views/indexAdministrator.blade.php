    ...
    <div class="row">
        ...
        <div class=".col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="pengGroup">
                        <span class="pengTitle">Daftar Nama Pendeta yang akan Pensiun Tahun 2020.</span>
                        <span class="pengDate">20 April 2020</span>
                    </div>
                    <div class="pengGroup">
                        <span class="pengTitle">Pendapatan Uang Kolekte Bulan Maret 2020.</span>
                        <span class="pengDate">18 April 2020</span>
                    </div>
                    <div class="pengGroup">
                        <span class="pengTitle">Pengumuman Kegiatan Bakti Sosial April 2020.</span>
                        <span class="pengDate">12 April 2020</span>
                    </div>
                </div>
            </div>
        </div>
