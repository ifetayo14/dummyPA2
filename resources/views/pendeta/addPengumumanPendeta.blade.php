            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="{{url('pengumumanPendeta')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                <textarea type="text" name="isi" style="width:630px;height:400px;" style="box-shadow:5px 5px 5px 5px grey;" class="ckeditor" id="ckeditor" placeholder="Isi Pengumuman" value="{{ old('isi') }}"></textarea>
                            </div>
