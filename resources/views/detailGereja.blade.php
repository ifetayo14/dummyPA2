            ...
            <div class="card shadow mb-4"><div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="{{url('editDataGereja')}}">Edit</a>
                ...
                <div class="card-body">
                    <table>
                        <tr>
                            <td>Nama Gereja</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</td>
                            <td>HKBP Sitoluama</td>
                        </tr>
                        <tr>
                            <td>Pendeta yang Bertugas</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</td>
                            <td>Pdt. Rinaldy Hutahuruk, S.Th</td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</td>
                            <td>Sitoluama, Lagu Boti, Kabupaten Toba Samosir, Sumatera Utara</td>
                        </tr>
                        <tr>
                            <td>Resort</td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</td>
