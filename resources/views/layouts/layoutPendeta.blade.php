...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('indexPendeta')}}">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item {{(request()->is('indexPendeta') ? 'active' : '')}}">
            <a class="nav-link" href="{{url('indexPendeta')}}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>Dashboard</span></a>
        </li>

        <li class="nav-item {{(request()->is('dataGerejaPendeta') ? 'active' : '')}}">
            <a class="nav-link" href="{{url('dataGerejaPendeta')}}">
                <i class="fas fa-fw fa-church"></i>
                <span>Data Gereja</span></a>
        </li>

        <li class="nav-item {{(request()->is('dataPendeta') ? 'active' : '')}}">
            <a class="nav-link" href="{{url('dataPendeta')}}">
                <i class="fas fa-fw fa-church"></i>
                <span>Data Pendeta</span></a>
        </li>

        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item {{(request()->is('kasPendeta') ? 'active' : '')}} {{(request()->is('kolektePendeta') ? 'active' : '')}}">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('kasPendeta')}}">Kas</a>
                    <a class="collapse-item" href="{{url('kolektePendeta')}}">Kolekte</a>
                </div>
            </div>
        </li>

        <li class="nav-item {{(request()->is('pengumumanPendeta') ? 'active' : '')}}">
            <a class="nav-link" href="{{url('pengumumanPendeta')}}">
