    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <a href="{{url('addPendetaAktifPersonalia')}}" class="btn btn-primary btn-icon-split btn-sm float-right btnAdd">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($dataPendeta as $row)
                        <tr>
                            ...
                            <td><a href="/detailPendetaAktifPersonalia/{{ $row['id'] }}">{{$row['name']}}</a></td>
