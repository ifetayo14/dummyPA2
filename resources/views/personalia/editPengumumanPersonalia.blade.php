            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="p-5">
                        ...
                        <form class="user" action="/updatePengumumanGerejaPersonalia/{{ $pengumumanGereja -> id }}" method="post">
                            @method('patch')
                            @csrf
                            ...
                            <div class="form-group">
                                <textarea type="text" class="form-control form-control-user" name="isi" id="exampleFirstName" placeholder="isi" value="{{ $pengumumanGereja -> isi}}">{{ $pengumumanGereja -> isi}}</textarea>
                            </div>
