    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <a href="{{url('addPendetaPensiunPersonalia')}}" class="btn btn-primary btn-icon-split btn-sm float-right btnAdd">
                    ...
                    <tbody>
                        @foreach($dataPendeta as $row)
                            <tr>
                                ...
                                <td><a href="/detailPendetaPensiunPersonalia/{{ $row['id'] }}">{{ $row['name'] }}</a></td>
